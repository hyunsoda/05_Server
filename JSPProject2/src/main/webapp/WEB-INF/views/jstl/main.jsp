...
<body>
	...
	<pre>
		...
		Java코드 (if, for, 변수 선언, 형변환)을 
		스크립틀릿대신 html태그 형식을 태그화하여 
		표준으로 제공하는 라이브러리
	...
	<c:remove var="num2"/> <%-- 모든 scope의 num2가 제거된다 --%>
	
	num2 제거 확인 : ${num2} 
	<%-- EL에서는 null값도 빈 값으로 처리 --%>
	...
	<c:set var="temp" value="<h1>배부르네요</h1>" />  <%-- 변수 만들기 --%>
	...
	<!-- /jst/condition이라는 요청 주소를 처리할 Controller가 필요함 : JSTLConditionController -->
	...
	<%-- 작성한 학과의 학생만 조회 SelectoOneController --%>
